...
이 스크립트가 새로 하는 일은 딱 세 가지:
  1. 원본 긴 영상 대신 STEP3_전처리/output/motion_guided_clips/ 의 짧은 클립들을 순회
...
DEFAULT_CLIPS_DIR = "/home/ai_user/team_a2/members/안나경/project-ai/STEP3_전처리/output/motion_guided_clips"
