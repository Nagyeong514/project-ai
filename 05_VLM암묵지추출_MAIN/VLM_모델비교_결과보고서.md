...
- **정답지(answerkey) 없이 정성 평가**만 수행 → recall/정확도 정량 채점 안 함. 본 선정은 "추출 품질 육안 비교" 수준.
...
> n=1(51624.mp4), 정성 비교, 심판=육안, 일시 2026-06-29. 최종 선정: **Qwen3-VL-8B**.
